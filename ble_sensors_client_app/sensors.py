...
def sens_photocell_estimate_lux(photocell_raw_read_val: int) -> int:
    ...
    rounded_to_nearest = min(photocell_resistance_lux_estimation_table.keys(),
                             lambda x: abs(x - photocell_resistance))
